...
static lpc43xx_partid_s lpc43xx_read_partid_onchip_flash(target *t);
static lpc43xx_partid_s lpc43xx_read_partid_flashless(target *t);
 ...
 */
static lpc43xx_partid_s lpc43xx_read_partid_flashless(target *const t)
{
